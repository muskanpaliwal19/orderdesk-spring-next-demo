...
Call log:
  ...
  - waiting for getByTestId('name-input')
    14 × locator resolved to <input id="name" type="text" required="" value="Test User" data-testid="name-input" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"/>
