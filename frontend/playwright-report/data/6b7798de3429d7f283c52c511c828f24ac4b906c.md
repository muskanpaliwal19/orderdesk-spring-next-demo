...
- Name: customer-registration.spec.ts >> Customer Registration >> should show an error if email is empty
- Location: tests/customer-registration.spec.ts:96:7
...
Error: strict mode violation: locator('div[role="alert"]') resolved to 2 elements:
    1) <div role="alert" class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4">…</div> aka getByRole('alert').filter({ hasText: 'Failed to execute \'json\' on \'' })
      ...
      - generic [ref=e10]:
        ...
        - generic [ref=e13]:
          ...
          - generic [ref=e15]:
            ...
            - textbox "Name" [ref=e17]: Test User
          - generic [ref=e18]:
